...
const [viewDoctor, setViewDoctor] = useState(null);
  ...
  bg-clip-text text-transparent"
          ...
          <div
            className="bg-gradient-to-r from-green-100 via-green-50 to-orange-100 
p-2 rounded-xl shadow-md mb-3 border border-orange-200"
  ...
  bg-clip-text text-transparent"
          >
            ...
            <VscArrowRight
              size={24}
              className="absolute right-0 top-1/2 -translate-y-1/2 cursor-pointer from-green-600 via-green-700 to-green-900 "
