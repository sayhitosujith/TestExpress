...
function DoctorList() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Left Navigation Bar */}
      <div className="w-64 bg-white shadow-lg fixed left-0 top-0 h-full overflow-y-auto border-r border-gray-200 flex flex-col">
        <div className="p-6 flex-1">
          <Typography variant="h5" className="font-bold text-orange-600 mb-8">
            Care ADHD
          </Typography>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <button
              ...
              className="w-full px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 transition duration-200 font-medium"
            >
              Sign Out
            </button>
          </div>
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            <div className="flex items-center gap-3 px-2 py-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition duration-200 cursor-pointer">
              ...
              {currentDoctors.map((doc, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Doctor Details */}
<div className="flex-1 w-full flex flex-col items-start text-left space-y-2 text-black">
  ...
  {doc.availableDays?.length > 0 && (
    <div className="flex flex-wrap gap-2 w-full">
      {doc.availableDays.map((day, i) => (
        <span
          key={i}
          className="px-2 py-1 text-[11px] border rounded-full bg-gray-50 border-gray-300"
        >
          {day}
        </span>
      ))}
