...
const handleToggle = (doctorIndex, value) => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Left Navigation Bar */}
      <div className="w-64 bg-green-100 text-white shadow-lg fixed left-0 top-0 h-full border-r border-blue-700 flex flex-col">
        {/* Logo and Navigation */}
        <div className="p-6 flex-1 overflow-y-auto">
          ...
          <nav className="space-y-2">
            <button
              ...
              className="w-full text-left px-4 py-2 rounded-lg text-white hover:bg-green-500 hover:text-white transition duration-200 flex items-center gap-3"
            >
            ...
            <button
              ...
              className="w-full text-left px-4 py-2 rounded-lg bg-green-700 text-white font-medium transition duration-200 flex items-center gap-3"
            >
        ...
        <div className="p-4 border-t border-green-700 bg-green-600">
          <div className="flex items-center gap-3 px-2 py-3 rounded-lg bg-green-600 hover:bg-green-500 transition duration-200 cursor-pointer shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        ...
        <Card className="p-4 sm:p-6 bg-gradient-to-r from-blue-50 to-purple-50 shadow-lg border border-blue-200">
          <div className="flex items-center gap-3">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-purple-400 flex items-center justify-center text-white text-2xl font-bold">
              {user.initials}
            </div>
            <div>
        ...
        <Card className="p-4 sm:p-6 bg-gradient-to-r from-green-50 to-orange-50 shadow-lg border border-green-200">
          ...
          <div className="bg-gradient-to-r from-green-100 to-green-100 p-3 rounded-lg mb-2 border border-green-200">
