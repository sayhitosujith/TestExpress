...
function EditDoctor() {
  ...
  const validate = () => {
    ...
    if (!doctor.consultationFee.toString().trim()) {
      newErrors.consultationFee = "Consultation fee is required";
    } else if (isNaN(doctor.consultationFee) || Number(doctor.consultationFee) <= 0) {
      ...
      <div className="flex flex-col gap-4">
        ...
        <Input 
          ...
          onChange={(e) => {
            ...
            setDoctor({ ...doctor, consultationFee: value });
          }}
          inputProps={{
            inputMode: "numeric",
            pattern: "[0-9]*",
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setDoctor({ ...doctor, isActive: e.target.checked })
            }
